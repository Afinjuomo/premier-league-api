...
describe('Admin Fixture Controller', () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const team1 = new teamModel_1.default({ name: 'Team A', city: 'City A', stadium: 'Stadium A' });
        const team2 = new teamModel_1.default({ name: 'Team B', city: 'City B', stadium: 'Stadium B' });
